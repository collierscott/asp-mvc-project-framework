...
(function ($) {
    ...
    function MultipleSelect($el, options) {
        ...
        this.$choice = $('<button type="button" id="' + options.id + '" class="ms-choice"><span class="placeholder">' + options.placeholder + '</span><div></div></button>');
        ...
        this.$choice.css({
            width: (options.boxWidth || elWidth) + 'px'
        });
    ...
    MultipleSelect.prototype = {
        ...
        init: function () {
            ...
            $.each(this.$el.children(), function (i, elm) {
                ...
                //setTimeout(html.push(that.optionToHtml(i, elm)), 1);
            });
    ...
    $.fn.multipleSelect = function () {
        ...
        var option = arguments[0],
			args = arguments,
			value,
			allowedMethods = ['getSelects', 'setSelects', 'enable', 'disable', 'checkAll', 'uncheckAll', 'refresh', 'force', 'hide', 'show'];
